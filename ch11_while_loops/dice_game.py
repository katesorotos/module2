...
def dice():
    ...
    print("The computer will roll 2 die and add the values together. You must decide whether the sum of these values is ODD or EVEN. ")
    print("Enter '1' for EVEN, '2' for ODD, '3' to QUIT")
